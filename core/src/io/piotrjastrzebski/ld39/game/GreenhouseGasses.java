...
public class GreenhouseGasses {

	private final ExtendViewport viewport;
	private final Map map;
	private final Buildings buildings;
	private final static float BORDER_START = 0f;
	private final static float BORDER_END = 3f;
	private final static float LIGHT_START = -.5f;
	private final static float LIGHT_END = 0.4f;
	private final static float DARK_START = 0.2f;
	private final static float DARK_END = 0.8f;
	private static final float GHG_DECAY = 0.01f;
	
	// 0-1
	private float ghg = 0f;
	private float ghgSeaRaise = .4f;
	private float ghgSeaLower = .2f;
	...
	public GreenhouseGasses (ExtendViewport viewport, Map map, Buildings buildings) {
